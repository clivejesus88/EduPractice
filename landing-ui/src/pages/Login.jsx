      ...
      >
        ...
        <div className="bg-[#111827] border border-gray-800 rounded-2xl p-5 sm:p-8">
          ...
          <div className="grid grid-cols-1 gap-3 ">
            <button className="py-2.5 px-3 sm:px-4 bg-[#1a1f2e] border border-gray-700 rounded-lg text-gray-300 hover:border-gray-600 transition-colors flex items-center justify-center gap">
              <svg
                className="w-8 h-5 flex-shrink-0"
                viewBox="0 0 24 24"
                fill="currentColor"
              >
                <path
